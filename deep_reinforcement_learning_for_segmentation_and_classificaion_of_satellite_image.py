# -*- coding: utf-8 -*-
"""deep reinforcement learning for segmentation and classificaion of Satellite Image.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1IljkTNXX77OYv8yNyxIbW8OB01qYMZ1Y
"""
...
class SatelliteSegmentationEnv(gym.Env):
    ...
    """
    def __init__(self, image, gt_mask, patch_size=16, num_classes=4):
...
patch_size = 16          # size of each patch (adjust according to your data)
...
# In your project, load a real image and the corresponding segmentation mask from SpaceNet.
H, W = 128, 128
